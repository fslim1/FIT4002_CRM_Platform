    ...
    const handleGoogleCredential = useCallback(
        async () => {
            ...
            try {
                ...
                const authCode = await requestGoogleSignInToken()
        ...
        >
            ...
            <main className="flex min-h-[calc(100vh-92px)] flex-col items-center px-4 py-10">
                ...
                >
                    ...
                    <button
                        type="button"
                        onClick={handleGoogleCredential}
                        disabled={submitting}
                        className="flex w-full items-center justify-center gap-3 rounded-full bg-white px-4 py-3 text-sm font-medium text-stone-700 shadow-sm transition hover:bg-stone-50 active:scale-[0.99] disabled:opacity-60"
                    >
                        ...
                        {submitting ? 'Connecting with Google…' : 'Continue with Google'}
                    </button>
                </section>
